...
def chat_anthropic(temperature: float = 0.2, model_name: str = "claude-3-sonnet-20240229"):
    ...
    return model
def chat_openai(temperature: float = 0.2, model_name: str = "gpt-4-0125-preview", openai_api_key: str = None):
    model = ChatOpenAI(temperature=temperature, model_name=model_name, openai_api_key=openai_api_key)
    return model
